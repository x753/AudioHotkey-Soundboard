...
namespace AudioHotkeySoundboard
{
  ...
  {
    readonly static SoundboardSettings DEFAULT_SOUNDBOARD_SETTINGS = new SoundboardSettings(new Keys[] { Keys.Pause }, new Keys[] { Keys.Oemtilde, Keys.LControlKey }, new LoadXMLFile[] { new LoadXMLFile(new Keys[] { }, "") }, false, false, true, false, "", "", "");
    ...
    public class SoundboardSettings
    {
      ...
      public bool MinimizeToTray, AutoStartup, PlaySoundsOverEachOther, RememberGainControl;
      ...
      public SoundboardSettings(Keys[] stopSoundKeys, Keys[] playSelectionKeys, LoadXMLFile[] loadXMLFiles, bool minimizeToTray, bool autoStartup, bool playSoundsOverEachOther, bool rememberGainControl, string lastPlaybackDevice, string lastPlaybackDevice2, string lastLoopbackDevice)
      {
